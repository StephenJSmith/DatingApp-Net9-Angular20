...
export class Register {
  ...
  protected isCredentialsStep = computed(() => this.currentStep() === 1);
  protected isProfileStep = computed(() => this.currentStep() === 2);
  protected validationErrors = signal<string[]>([]);
  protected isValidationErrors = computed(() => this.validationErrors().length > 0);
